...
//         [await address, ethService.getAddrHex("bakkt_swap_contract")]);
...
//       await ethService.getAddrHex("bakkt_swap_contract"),
//       getWei(amount, token)
//     ]);
//     return res;
//   }
...
//       final bakktAmount = fromWei(res[0], toToken);
//       //      TODO
...
//     final DeployedContract contract = await ethService.loadContractWithGivenAddress(
//         "sps", await ethService.getAddrHex("bakkt_swap_contract"));
//     if (fromToken == "bakkt" && toToken == "deus") {
//       final res = await ethService.query(
//           contract, "calculateSaleReturn", [getWei(amountIn, fromToken)]);
//       return fromWei(res[0], toToken);
//     } else if (fromToken == "deus" && toToken == "bakkt") {
//       final res = await ethService.query(
//           contract, "calculatePurchaseReturn", [getWei(amountIn, fromToken)]);
//       return fromWei(res[0], toToken);
//     }
//   }
//
...
//     if (!checkWallet()) return "0";
//     final DeployedContract automaticMarketMakerContract =
//         await ethService.loadContract("amm");
...
//     final amount = BigInt.from(pow(10, 25));
//
//     final DeployedContract tokenContract = await ethService.loadTokenContract("dai");
//     final res = await ethService.submit(
//         await credentials, tokenContract, "approve", [
//       await ethService.getAddrHex("stocks_contract"),
//       getWei(amount, "ether")
//     ]);
//     return res;
//   }
...
//     final DeployedContract tokenContract = await ethService.loadTokenContract("dai");
//     final res = await ethService.query(tokenContract, "allowance",
//         [await address, ethService.getAddrHex("stocks_contract")]);
...
//       return "0";
//     }
//     final String tokenAddress = await ethService.getTokenAddrHex(tokenName, "token");
//     final DeployedContract contract =
//         await ethService.loadContract("stocks_contract");

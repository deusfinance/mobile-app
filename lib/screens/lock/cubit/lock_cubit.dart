...
// import '../../../service/vaults_service.dart';
...
//
//     try {
//       final res = await state.vaultsService
...
//     final Transaction? transaction = await state.vaultsService.makeLockTransaction(
...
//     if (gas != null) {
//       try {
//         final res = await state.vaultsService.lock(
//             state.stakeTokenObject.lockToken.getTokenName(),
//             state.fieldController.text,
//             gas);
...
//     return await state.vaultsService.makeApproveTransaction(
//         state.stakeTokenObject.lockToken.getTokenName());
//   }
// }

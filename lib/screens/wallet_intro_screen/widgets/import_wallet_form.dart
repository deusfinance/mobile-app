...
class ImportWalletForm extends HookWidget {
  ...
  static const indexMap = {
    0: WalletImportType.mnemonic,
    1: WalletImportType.privateKey
  };
  ...
  Widget build(BuildContext context) {
    ...
    const LinearGradient buttonGradient =
          ...
          child: PaperForm(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  ToggleButtons(
                    borderColor: const Color(MyColors.Background),
                    selectedBorderColor: const Color(MyColors.Background),
                    fillColor: Colors.transparent,
                    children: [
                      Padding(
                          padding: const EdgeInsets.only(right: 20),
                          child: _buildImportOption('Seed',
                              WalletImportType.mnemonic, importType.value)),
                      _buildImportOption('Private key',
                          WalletImportType.privateKey, importType.value)
                    ],
                    isSelected: [
  ...
  Text _buildImportOption(
      String label, WalletImportType type, WalletImportType currentType) {
    return Text(
      label,
      style: TextStyle(
        fontSize: 15,

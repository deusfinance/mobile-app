...
// import 'confirm_swap_cubit_screen.dart';
...
//   var fromFieldController = new TextEditingController();
//   var toFieldController = new TextEditingController();
//   var slippageController = new TextEditingController();
...
//     List<String> value = await swapService.getPath(swapModel.from.getTokenName(), swapModel.to.getTokenName());
//     List<Token> r = [];
//     value.forEach((addr) {
...
//                               (index < snapshot.data.length - 1) ? _buildRouteTransformWidget(snapshot.data, index) : Container(),
//                             ],
//                           ),
//                         );
//                       });
...
//   }
//
//   Future<double> computePriceImpact(String _input, String _y) async {
